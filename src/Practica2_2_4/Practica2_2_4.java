package Practica2_2_4;

import java.util.concurrent.atomic.AtomicLong;

public class Practica2_2_4 {
...
class CuentaIncrementos {
    AtomicLong numIncrementos = new AtomicLong();

    public CuentaIncrementos(){
        numIncrementos.set(0);
    }

    void incrementaNumIncrementos() {
        numIncrementos.getAndAdd(1);    }
